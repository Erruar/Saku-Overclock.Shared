...
{
    public PresetOption<double> AutomaticTemperatureManagement =  new(false, 90);
    ...
    public PresetOption<double> AutomaticPowerManagement =  new(false, 50);
    ...
    public PresetOption<double> AutomaticTurboManagement =  new(false, 30);
